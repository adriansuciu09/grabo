  ...
  created() {
    this.tasks = [
      {id: 1, text: 'Termin 1', date: '2023-06-27', time: '08:00', description: 'Beschreibung 1', show: false},
      {
        ...
        date: '2023-06-20',
        time: '15:30',
        description: 'Eine Beschreibung mit übertrieben viel Text, der im endeffekt keinen Sinn ergeben wird, sondern einfach nur die Beschreibung füllen soll, um zu sehen wie das Ganze zum Schluss aussehen wird und gegebenfalls angepasst werden kann.',
        show: false
      },
